...
const Sims = {
  ...
  <ellipse cx="44" cy="22" rx="10" ry="4.5" fill="rgba(255,255,255,.5)"/>
    ...
    function updatePayZone() {
      ...
      // Full pyramid: row0=1, row1=2, row2=3, row3=4  (1+2+3+4=10)
      const STACK_LAYOUTS = [
        null,
        [[0, 0]],                                                                             // 1: single
        [[0, 0], [2, 0]],                                                                     // 2: 2-row
        [[1, 0], [0, 1], [2, 1]],                                                             // 3: 1+2
        [[2, 0], [0, 1], [2, 1], [4, 1]],                                                    // 4: 1+3
        [[1, 0], [3, 0], [0, 1], [2, 1], [4, 1]],                                           // 5: 2+3
        [[2, 0], [1, 1], [3, 1], [0, 2], [2, 2], [4, 2]],                                   // 6: 1+2+3
        [[1, 0], [3, 0], [5, 0], [0, 1], [2, 1], [4, 1], [6, 1]],                          // 7: 3+4
        [[3, 0], [1, 1], [3, 1], [5, 1], [0, 2], [2, 2], [4, 2], [6, 2]],                  // 8: 1+3+4
        [[2, 0], [4, 0], [1, 1], [3, 1], [5, 1], [0, 2], [2, 2], [4, 2], [6, 2]],          // 9: 2+3+4
        [[3, 0], [2, 1], [4, 1], [1, 2], [3, 2], [5, 2], [0, 3], [2, 3], [4, 3], [6, 3]], // 10: 1+2+3+4
      ];
